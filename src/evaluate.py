...
def main(args):
    ...
    if args.test_ids is not None:
        ...
        test_data = read_data(args.test_context, args.test_question, None,
                              args.max_post_len, args.max_ques_len, mode='test')
...
def run_model(test_data, word_embeddings, word2index, index2word, args):
    ...
    te_id_seqs, te_post_seqs, te_post_lens, te_ques_seqs, te_ques_lens = preprocess_data(test_data, word2index,
                                                                                         args.max_post_len,
                                                                                         args.max_ques_len)
